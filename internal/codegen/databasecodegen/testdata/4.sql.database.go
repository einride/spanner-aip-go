...
func (r *SinglesRow) InsertDML() spanner.Statement {
	insert := &spansql.Insert{
		Table:   "Singles",
		Columns: r.ColumnIDs(),
		Input: spansql.Values{
...
func (i *streamingSinglesRowIterator) Count() int64 {
	return i.RowCount
}
...
func (i *bufferedSinglesRowIterator) Count() int64 {
	return int64(len(i.rows))
}
