// Code generated by TestTableDescriptorCodeGenerator_GenerateCode/table/testdata/3.sql. DO NOT EDIT.
//go:build testdata.3.sql.table
// +build testdata.3.sql.table
