//go:build testdata.3.sql.genericcolumn
// +build testdata.3.sql.genericcolumn

package testdata

// Code generated by TestGenericColumnDescriptorCodeGenerator_GenerateCode/genericcolumn/testdata/3.sql. DO NOT EDIT.
